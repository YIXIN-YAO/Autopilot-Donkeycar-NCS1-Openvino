...
DATA_PATH = os.path.join(CAR_PATH, 'data_55_light')
MODELS_PATH = os.path.join(CAR_PATH, 'models')

AI_THROTTLE_MULT = 1.0#0.95
#VEHICLE
DRIVE_LOOP_HZ = 20
MAX_LOOPS = 100000
...
MODEL_CATEGORICAL_MAX_THROTTLE_RANGE = 0.3
...
AUTO_RECORD_ON_THROTTLE = False#True      #if true, we will record whenever throttle is not zero. if false, you must manually toggle recording with some other trigger. Usually circle button on joystick.
