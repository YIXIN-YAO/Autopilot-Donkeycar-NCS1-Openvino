...
class JoystickController(object):
    ...
    def green_light_speed(self):
        self.throttle = 0.25
        print('greenlight:',0.25)
    def no_light_speed(self):
        self.throttle = 0.245
        print('nolight:',0.245)
    def yellow_light_speed(self):
        self.throttle = 0.235
        print('yellowlight:',0.235)
    def red_light_speed(self):
        self.throttle = 0.0
        print('redlight:',0.0)
...
class XboxOneJoystickController(JoystickController):
    ...
    def init_trigger_maps(self):
        ...
        self.button_down_trigger_map = {
            ...
            'right_shoulder': self.no_light_speed,
            'left_shoulder':  self.red_light_speed,
            #'options': self.toggle_constant_throttle,
            'left_2': self.green_light_speed,
            'right_2': self.yellow_light_speed,
        }
